...
class VinyaikinaEMatrixSumFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_vinyaikina_e_matrix_sum, "pic.jpg");
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<VinyaikinaEMatrixSumMPI, InType>(kTestParam, PPC_SETTINGS_vinyaikina_e_matrix_sum),
