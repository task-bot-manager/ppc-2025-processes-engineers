...
class VinyaikinaEQuicksortSimpleFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_vinyaikina_e_quicksort_simple, "pic.jpg");
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<VinyaikinaEQuicksortSimpleMPI, InType>(kTestParam, PPC_SETTINGS_vinyaikina_e_quicksort_simple),
                   ppc::util::AddFuncTask<VinyaikinaEQuicksortSimpleSEQ, InType>(kTestParam, PPC_SETTINGS_vinyaikina_e_quicksort_simple));
